...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`alunos` (`matricula`, `data_de_ingresso`, `data_de_conclusao_prevista`, `cursos_cod_curso`, `usr_level1_usuarios_id`) VALUES (1, '2022-06-27', '28/06/2024', 1, 5);
INSERT INTO `mydb`.`alunos` (`matricula`, `data_de_ingresso`, `data_de_conclusao_prevista`, `cursos_cod_curso`, `usr_level1_usuarios_id`) VALUES (2, '2022-06-27', '28/06/2024', 1, 6);
INSERT INTO `mydb`.`alunos` (`matricula`, `data_de_ingresso`, `data_de_conclusao_prevista`, `cursos_cod_curso`, `usr_level1_usuarios_id`) VALUES (3, '2022-06-27', '28/06/2024', 1, 7);
