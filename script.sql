...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`categorias` (`cod_categoria`, `descricao`) VALUES (Cálculo, 'Livros para a disciplina de cálculo.');
INSERT INTO `mydb`.`categorias` (`cod_categoria`, `descricao`) VALUES (Física, 'Livros para a disciplina de física.');
INSERT INTO `mydb`.`categorias` (`cod_categoria`, `descricao`) VALUES (Programação, 'Livros para programação.');
INSERT INTO `mydb`.`categorias` (`cod_categoria`, `descricao`) VALUES (Redes, 'Livros para a disciplina de redes.');
INSERT INTO `mydb`.`categorias` (`cod_categoria`, `descricao`) VALUES (Web, 'Livros para a disciplina de dev web.');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`livros` (`isbn`, `titulo`, `ano_lancamento`, `editora`, `qtd_copias`, `categorias_cod_categoria`) VALUES (1, 'Cálculo Vol1', '2000', 'trilha', 20, Cálculo);
INSERT INTO `mydb`.`livros` (`isbn`, `titulo`, `ano_lancamento`, `editora`, `qtd_copias`, `categorias_cod_categoria`) VALUES (2, 'Física Vol 1', '2000', 'ltc', 20, Física);
INSERT INTO `mydb`.`livros` (`isbn`, `titulo`, `ano_lancamento`, `editora`, `qtd_copias`, `categorias_cod_categoria`) VALUES (3, 'Padrões de projeto', '2008', 'bookman', 20, Programação);
INSERT INTO `mydb`.`livros` (`isbn`, `titulo`, `ano_lancamento`, `editora`, `qtd_copias`, `categorias_cod_categoria`) VALUES (4, 'Comunicação de dados e redes de computadores', '2008', 'bookman', 20, Redes);
INSERT INTO `mydb`.`livros` (`isbn`, `titulo`, `ano_lancamento`, `editora`, `qtd_copias`, `categorias_cod_categoria`) VALUES (5, 'Criação de Sites na era da Web 2.0', '2011', 'brasport', 20, Web);
